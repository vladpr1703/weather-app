...
function renderTomorrowWeather(t_c, t_f, icon, condition){
    ...
    const main = document.querySelector('.tomorrow');
    const tomorrowDate = document.querySelector('.tomorrow_date');
    ...
    main.append(tomorrowDate, iconSpan, condit, temp_c, temp_f);
}
